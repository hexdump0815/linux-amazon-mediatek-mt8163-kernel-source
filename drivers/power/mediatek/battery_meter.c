...
int g_battery_id_voltage[] = { 1200000, -1};
...
void fgauge_get_profile_id(void)
{
	...
	if ((sizeof(g_battery_id_voltage) / sizeof(signed int)) != TOTAL_BATTERY_NUMBER) {
		pr_notice("[fgauge_get_profile_id]error! voltage range incorrect!\n");
		return;
	}
				...
				const char *node_srting, BATTERY_PROFILE_STRUCT_P profile_p)
{
	...
	/* error handle */
	if (idx == 0) {
		pr_notice("batt_meter_parse_table: %s, idx = 0\n", node_srting);
		return;
	}
...
static void __batt_meter_parse_aging_data(const struct device_node *np)
{
	...
	__batt_meter_parse_table(np, "battery_profile_t0_500cycle_1",
		&battery_profile_t0_500cycle[0]);
	__batt_meter_parse_table(np, "battery_profile_t1_500cycle_1",
		&battery_profile_t1_500cycle[0]);
	__batt_meter_parse_table(np, "battery_profile_t1_5_500cycle_1",
		&battery_profile_t1_5_500cycle[0]);
	__batt_meter_parse_table(np, "battery_profile_t2_500cycle_1",
		&battery_profile_t2_500cycle[0]);
	__batt_meter_parse_table(np, "battery_profile_t3_500cycle_1",
		&battery_profile_t3_500cycle[0]);

	__batt_meter_parse_table(np, "r_profile_t0_500cycle_1",
		(BATTERY_PROFILE_STRUCT *)&r_profile_t0_500cycle[0]);
	__batt_meter_parse_table(np, "r_profile_t1_500cycle_1",
		(BATTERY_PROFILE_STRUCT *)&r_profile_t1_500cycle[0]);
	__batt_meter_parse_table(np, "r_profile_t1_5_500cycle_1",
		(BATTERY_PROFILE_STRUCT *)&r_profile_t1_5_500cycle[0]);
	__batt_meter_parse_table(np, "r_profile_t2_500cycle_1",
		(BATTERY_PROFILE_STRUCT *)&r_profile_t2_500cycle[0]);
	__batt_meter_parse_table(np, "r_profile_t3_500cycle_1",
		(BATTERY_PROFILE_STRUCT *)&r_profile_t3_500cycle[0]);

	__batt_meter_parse_node(np, "q_max_neg_10_500cycle_1",
		&q_max_t0_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_0_500cycle_1",
		&q_max_t1_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_10_500cycle_1",
		&q_max_t1_5_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_25_500cycle_1",
		&q_max_t2_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_50_500cycle_1",
		&q_max_t3_aging.Q_500_CYCLE);

	__batt_meter_parse_node(np, "q_max_neg_10_h_current_500cycle_1",
		&q_max_t0_h_current_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_0_h_current_500cycle_1",
		&q_max_t1_h_current_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_10_h_current_500cycle_1",
		&q_max_t1_5_h_current_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_25_h_current_500cycle_1",
		&q_max_t2_h_current_aging.Q_500_CYCLE);
	__batt_meter_parse_node(np, "q_max_pos_50_h_current_500cycle_1",
		&q_max_t3_h_current_aging.Q_500_CYCLE);
			}
}
#endif
...
int __batt_meter_init_cust_data_from_dt(void)
{
	...
	__batt_meter_parse_node(np, "battery_profile_t1_5_num_1", &num);

	__batt_meter_parse_table(np, "battery_profile_t1_5_1",
			fgauge_get_profile(batt_meter_cust_data.temperature_t1_5));
	...
	__batt_meter_parse_node(np, "r_profile_t1_5_num_1", &num);

	__batt_meter_parse_table(np, "r_profile_t1_5_1",
			(BATTERY_PROFILE_STRUCT *)fgauge_get_profile_r_table(batt_meter_cust_data.temperature_t1_5));
	...
	__batt_meter_parse_node(np, "q_max_pos_10_1",
		&batt_meter_cust_data.q_max_pos_10);
	...
	__batt_meter_parse_node(np, "q_max_pos_10_h_current_1",
		&batt_meter_cust_data.q_max_pos_10_h_current);

	__batt_meter_parse_node(np, "q_max_pos_0_h_current_1",
		&batt_meter_cust_data.q_max_pos_0_h_current);

	__batt_meter_parse_node(np, "q_max_neg_10_h_current_1",
		&batt_meter_cust_data.q_max_neg_10_h_current);
	}
			       ...
			       size_t len, loff_t *data)
{
	...
	if ((len <= 0) || copy_from_user(&proc_fgadc_data, buff, 1)) {
		pr_notice("fgadc_log_write error.\n");
		return -EFAULT;
	}

	if (proc_fgadc_data == '1') {
		pr_notice("enable FGADC driver log system\n");
		Enable_FGADC_LOG = 1;
	} else if (proc_fgadc_data == '2') {
		pr_notice("enable FGADC driver log system:2\n");
		Enable_FGADC_LOG = 2;
	} else {
		pr_notice("Disable FGADC driver log system\n");
		Enable_FGADC_LOG = 0;
	}
...
int init_proc_log_fg(void)
{
	...
	pr_notice("proc_create fgadc_proc_fops\n");
#else
	proc_entry_fgadc = create_proc_entry("fgadc_log", 0644, NULL);

	if (proc_entry_fgadc == NULL) {
		ret = -ENOMEM;
		pr_notice("init_proc_log_fg: Couldn't create proc entry\n");
	} else {
		proc_entry_fgadc->write_proc = fgadc_log_write;
		pr_notice("init_proc_log_fg loaded.\n");
	}
#endif
