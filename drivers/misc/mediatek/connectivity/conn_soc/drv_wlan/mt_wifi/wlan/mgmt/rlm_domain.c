...
static const UINT_16 g_u2CountryGroup10[] = {
	...
	COUNTRY_CODE_CN,
#endif
	COUNTRY_CODE_SV, COUNTRY_CODE_MY, COUNTRY_CODE_MV,
	COUNTRY_CODE_PA, COUNTRY_CODE_VE, COUNTRY_CODE_ZM,

};
static const UINT_16 g_u2CountryGroup11[] = { COUNTRY_CODE_IN,
...
#define SUPPORT_abh123		BIT(1)
#define SUPPORT_abd123		BIT(2)
#define SUPPORT_GIZA		BIT(3)
